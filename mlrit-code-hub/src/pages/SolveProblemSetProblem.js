...
import "./SolveProblemSetProblem.css";
...
const SolveProblem = () => {
  ...
  const [codeHeight, setCodeHeight] = useState(65); // Percentage for code area height
  ...
  return (
    <div className="solve-page">
      <div className="solve-container">
        ...
        <div className="solve-left" style={{ width: '45%' }}>
        ...
        <div className="solve-right" style={{ width: '55%' }} ref={verticalContainerRef}>
          {/* Right Top Panel - Code Editor */}
          <div className="solve-right-top" style={{ height: `${codeHeight}%` }}>
          ...
          {/* Vertical Resizer between code editor and test cases */}
          <div className="vertical-resizer" onMouseDown={startVerticalDrag} />

          {/* Right Bottom Panel - Test Cases and Results */}
          <div className="solve-right-bottom" style={{ height: `${100 - codeHeight}%` }}>
